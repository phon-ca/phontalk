...
@PhonPlugin(name=PhonTalkDebugView.VIEW_NAME)
@EditorViewInfo(name=PhonTalkDebugView.VIEW_NAME, category=EditorViewCategory.PLUGINS, icon=PhonTalkDebugView.VIEW_ICON)
public class PhonTalkDebugViewFactory implements IPluginExtensionPoint<EditorView> {
	...
	private final IPluginExtensionFactory<EditorView> factory = new IPluginExtensionFactory<EditorView>() {
		...
		public EditorView createObject(Object... args) {
			...
			return new PhonTalkDebugView(editor);
		}
