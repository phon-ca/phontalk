 ...
 *
 */
public class Phon2XmlStreamTask extends PhonTask {
	
	private InputStream phonStream;
	
	private OutputStream tbStream;
	
	public Phon2XmlStreamTask(String inFile, String outFile) {
		try {
	...
	public Phon2XmlStreamTask(InputStream inStream, OutputStream outStream) {
