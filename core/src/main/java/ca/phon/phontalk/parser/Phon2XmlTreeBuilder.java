...
public class Phon2XmlTreeBuilder {
	...
	private void processSessionComment(CommonTree parent, Comment comment) {
		if(comment.getTag().equals("LazyGem")) {
			...
			parent.insertChild(0, activityTypeTree);
			...
			parent.insertChild(0, groupTypeTree);
			...
			parent.insertChild(0, designTypeTree);
			...
			parent.insertChild(0, colorwordTree);
			...
			parent.insertChild(0, optionsTree);
			...
			List<CommonTree> mediaTypesTrees = AntlrUtils.findChildrenWithType(parent, talkbankTokens, "CHAT_ATTR_MEDIATYPES");
